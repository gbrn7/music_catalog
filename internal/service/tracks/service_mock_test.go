...
// GetBulkBySpotifyIDs mocks base method.
func (m *MocktrackActivitiesRepository) GetBulkBySpotifyIDs(ctx context.Context, userID uint, spotifyIDs []string) (map[string]trackactivities.TrackActivity, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBulkBySpotifyIDs", ctx, userID, spotifyIDs)
	ret0, _ := ret[0].(map[string]trackactivities.TrackActivity)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetBulkBySpotifyIDs indicates an expected call of GetBulkBySpotifyIDs.
func (mr *MocktrackActivitiesRepositoryMockRecorder) GetBulkBySpotifyIDs(ctx, userID, spotifyIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBulkBySpotifyIDs", reflect.TypeOf((*MocktrackActivitiesRepository)(nil).GetBulkBySpotifyIDs), ctx, userID, spotifyIDs)
}
